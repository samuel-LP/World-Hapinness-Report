...
st.write("""
         Ceci est une visualisation des données extraites du World Happiness Report, 
         un sondage mondial sur l'état du bonheur global. Le rapport classe 156 pays 
         par leur niveau de bonheur, mesuré par des facteurs tels que le PIB par habitant, 
         le soutien social, l'espérance de vie en bonne santé, la liberté de faire des choix de vie, 
         la générosité et la perception de la corruption. Cette visualisation se concentre 
...
pays = st.selectbox(label = 'Selectionner un pays', options = df_clean["Country name"].values)
